...
``
docker run --name ec-app -p 8080:8080 -v "ABSOLUTE_PATH":/var/migration -e server=ec-mysql -e port=3306 -e dbuser=cali_user -e dbpassword=cali_pass --link ec-mysql:mysql -d explorecali
``
